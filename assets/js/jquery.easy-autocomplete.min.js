...
var EasyAutocomplete = function (a) {
        ...
        return a.ListBuilderService = function (a, b) {
            function c(b, c) {
                function d() {
                    var d,
                        e = {};
                    return void 0 !== b.xmlElementName && (e.xmlElementName = b.xmlElementName), void 0 !== b.listLocation ? d = b.listLocation : void 0 !== a.get('listLocation') && (d = a.get('listLocation')), void 0 !== d ? 'string' == typeof d ? e.data = $(c)
                        .find(d) : 'function' == typeof d && (e.data = d(c)) : e.data = c, e;
                }
                ...
                var f = {};
                if (f = 'XML' === a.get('dataType')
                    .toUpperCase() ? d() : e(), void 0 !== b.header && (f.header = b.header), void 0 !== b.maxNumberOfElements && (f.maxNumberOfElements = b.maxNumberOfElements), void 0 !== a.get('list').maxNumberOfElements && (f.maxListSize = a.get('list').maxNumberOfElements), void 0 !== b.getValue) {
            ...
            function d(b) {
                var c = [];
                return void 0 === b.xmlElementName && (b.xmlElementName = a.get('xmlElementName')), $(b.data)
    ...
    EasyAutocomplete = function (a) {
        return a.proccess = function (b, c, d) {
            ...
            function f(a, c) {
                return b.get('list').match.caseSensitive || ('string' == typeof a && (a = a.toLowerCase()), c = c.toLowerCase()), !!b.get('list')
                    .match
                    .method(a, c);
            }
    ...
    EasyAutocomplete = function (a) {
        return a.main = function (b, c) {
            ...
            function e() {
                ...
                function d() {
                    var a = $('<div>')
                        .addClass(n.getValue('CONTAINER_CLASS'));
                    a.attr('id', f())
                        .prepend($('<ul>')), function () {
                        a.on('show.eac', function () {
                            ...
                            .on('selectElement.eac', function () {
                                a.find('ul li')
                                    .removeClass('selected'), a.find('ul li')
                                    .eq(w)
                                    .addClass('selected'), o.get('list')
                                    .onSelectItemEvent();
                            })
                                        ...
                                        for (var m = 0, n = l.length; n > m && h < c[i].maxListSize; m += 1) {
                                            e = $('<li><div class=\'eac-item\'></div></li>'), function () {
                                                ...
                                                e.find(' > div')
                                                    .on('click', function () {
                                                        t.val(f)
                                                            .trigger('change'), w = b, j(b), o.get('list')
                                                            .onClickEvent(), o.get('list')
                                                            .onChooseEvent();
                                                    })
                                                    .mouseover(function () {
                                                        w = b, j(b), o.get('list')
                ...
                function e() {
                    t.next('.' + n.getValue('CONTAINER_CLASS'))
                        .remove();
                }
                ...
                t.parent()
                    .hasClass(n.getValue('WRAPPER_CSS_CLASS')) && (e(), c()), a(), d(), u = $('#' + f()), o.get('placeholder') && t.attr('placeholder', o.get('placeholder'));
            }
            ...
            function g() {
                            ...
                            function b(a) {
                                ...
                                if (!(a.length < o.get('minCharNumber'))) {
                                    if ('list-required' !== o.get('data')) {
                                        var d = o.get('data'),
                                            e = r.init(d);
                                        e = r.updateCategories(e, d), e = r.processData(e, a), k(e, a), t.parent()
                                            .find('li').length > 0 ? h() : i();
                                    }
                                    var f = b();
                                    void 0 !== f.url && '' !== f.url || (f.url = o.get('url')), void 0 !== f.dataType && '' !== f.dataType || (f.dataType = o.get('dataType')), void 0 !== f.url && 'list-required' !== f.url && (f.url = f.url(a), f.data = o.get('preparePostData')(f.data, a), $.ajax(f)
                                        .done(function (b) {
                                            var d = r.init(b);
                                            d = r.updateCategories(d, b), d = r.convertXml(d), c(a, b) && (d = r.processData(d, a), k(d, a)), r.checkIfDataExists(d) && t.parent()
                                                .find('li').length > 0 ? h() : i(), o.get('ajaxCallback')();
                                        })
                                        .fail(function () {
                ...
                function d() {
                    t.on('keydown', function (a) {
                        ...
                        .keydown(function (a) {
                            13 === a.keyCode && w > -1 && (t.val(o.get('getValue')(v[w])), o.get('list')
                                .onKeyEnterEvent(), o.get('list')
                                .onChooseEvent(), w = -1, i(), a.preventDefault());
                        });
                }
            ...
            elementId = a.consts.getValue('CONTAINER_ID') + c, $(b)
                .attr('id', c);
...
!function (a) {
    a.fn.easyAutocomplete = function (b) {
        ...
        var b = a(this)
            .attr('id');
        return void 0 !== b ? EasyAutocomplete.getHandle(b)
        ...
        var c = a(this)
            .attr("id");
        return void 0 !== c && b > -1 ? EasyAutocomplete.getHandle(c)
            .getItemData(b) : -1
    }, a.fn.getSelectedItemData = function () {
        var b = a(this)
            .attr("id");
        return void 0 !== b ? EasyAutocomplete.getHandle(b)
            .getSelectedItemData() : -1
    }
}(jQuery);
